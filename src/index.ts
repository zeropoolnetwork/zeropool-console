...
const COMMANDS: { [key: string]: [(...args) => void, string, string] } = {
  ...
  'transfer-shielded': [c.transferShielded, '<shielded address> <amount>', ''],
  'deposit-shielded': [c.depositShielded, '<amount>', ''],
  'deposit-delegated': [c.depositDelegated, '<to> <amount>', 'make a deposit to the specified address without generating a proof on the client'],
  'withdraw-shielded': [c.withdrawShielded, '<amount>', ''],
